...
var _debug = require('./utilities/debug');
...
var LFSR = function () {
  ...
  function LFSR() {
    ...
    if (m < 1 || m > _constants.bits_in_number) {
      throw new RangeError('m must be in the range 1..' + _constants.bits_in_number + ' (inclusive)');
    }
  ...
  _createClass(LFSR, [{
     ...
     * @access protected
     */
    value: function log_taps() {
      (0, _debug.log_taps)(this.sanitized_feedback_taps, this.current_state, this.m);
    }
  }, {
    key: 'output_bit',
    get: function get() {
