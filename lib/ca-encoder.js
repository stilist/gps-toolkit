...
var _caEncoderG = require('./ca-encoder-g1');

var _caEncoderG2 = _interopRequireDefault(_caEncoderG);

var _caEncoderG3 = require('./ca-encoder-g2');

var _caEncoderG4 = _interopRequireDefault(_caEncoderG3);

var _goldCode = require('./gold-code');

var _goldCode2 = _interopRequireDefault(_goldCode);
...
var CAEncoder = function (_GoldCode) {
  ...
  function CAEncoder(sv) {
    _classCallCheck(this, CAEncoder);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CAEncoder).call(this, 10));
  ...
  _createClass(CAEncoder, [{
    key: 'lfsrs',
    get: function get() {
      if (this._lfsrs) return this._lfsrs;

      var lfsrA = new _caEncoderG2.default();
      var lfsrB = new _caEncoderG4.default(this.sv);
...
exports.default = CAEncoder;
//# sourceMappingURL=ca-encoder.js.map