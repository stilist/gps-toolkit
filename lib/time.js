 ...
 * > 1980. The largest unit used in stating GPS time is one week defined as
...
var Time = function () {
  ...
  _createClass(Time, [{
    ...
    get: function get() {
      var milliseconds_since_epoch = this.date.getTime() - this.epoch.getTime();
    ...
    key: 'time_of_week',
    get: function get() {
      var start_of_week = new Date(this.epoch.getTime() + this.week_number * this.seconds_in_week * 1000);
